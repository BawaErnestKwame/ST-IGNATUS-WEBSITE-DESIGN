...
const Navbar = () => {
  ...
  return (
    ...
    <header className={`w-full shadow border-b border-gray-400 z-50 transition-all duration-500 ${
      ...
      {/* Mobile Header - Logo, Contact Info & Menu Icon */}
      ...
      <div className="hidden lg:flex gap-4 md:gap-8 px-4 md:px-8">
        ...
        <div className="w-full lg:border-l lg:border-gray-400 lg:pl-8">
          ...
          {/* TOP BAR */}
          <div className={`bg-[#f8faff] text-xs sm:text-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0 transition-all duration-300 ${
            isSticky ? "py-1" : "py-2"
          }`}>
              ...
              >
                <motion.li variants={linkVariants} className="border-b border-gray-200 pb-2">
                  <NavLink 
                    ...
                    className={({ isActive }) => `block transition-colors ${isActive ? 'text-blue-600 font-semibold' : 'hover:text-blue-600'}`}
                  >
                    Home
                  </NavLink>
                </motion.li>
                ...
                <motion.li variants={linkVariants} className="border-b border-gray-200 pb-2">
                  <div>
                    ...
                    >
                      <span>About</span>
                      <ArrowRightIcon 
                        className={`transition-transform duration-300 ${aboutOpen ? 'rotate-90' : ''}`} 
                      />
                    </div>
                    <motion.ul 
                    ...
                    >
                      <li>
                        <NavLink 
                          to="/about" 
                          onClick={toggleMobileMenu} 
                          className={({ isActive }) => `block py-1 transition-colors ${isActive ? 'text-blue-600 font-semibold' : 'hover:text-blue-600'}`}
                        >
                          About Us
                        </NavLink>
                      </li>
                ...
                <motion.li variants={linkVariants} className="border-b border-gray-200 pb-2">
                  <div>
                    ...
                    >
                      <span>Branches</span>
                      <ArrowRightIcon 
                        className={`transition-transform duration-300 ${branchesOpen ? 'rotate-90' : ''}`} 
                      />
                    </div>
                    <motion.ul 
                      className="ml-4 mt-2 space-y-2 overflow-hidden"
                ...
                <motion.li variants={linkVariants}>
                  <button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 w-full mt-4 text-white py-3 rounded-md flex items-center gap-2 justify-center transition-colors"
                  >
                    <FaUserPlus /> Book Appointment
                  </button>
                </motion.li>
