          ...
          <div className="space-y-8 mt-20">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Book your visit today and get personalized eye care from our experienced specialists. Schedule your appointment now for expert attention and quality treatment in a comfortable environment.
            ...
            <div className="bg-gray-200 rounded-xl p-6 shadow-sm">
              <h3 className="text-xl contact font-bold text-gray-900 mb-6">Contact Us for More Information</h3>
            ...
            {/* Social Media */}
              <div>
                <div className="flex items-center mb-3">
                  ...
                  style={{ fontFamily: 'Montserrat, sans-serif' }}>Social Media</h4>
                  <div className="flex-1 h-px bg-gray-300 ml-4"></div>
                </div>
                <div className="flex space-x-3">
                  <button className="bg-blue-600 hover:bg-blue-700 rounded-lg p-2 transition-colors">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="4"
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none bg-white"
                ></textarea>
              </div>
